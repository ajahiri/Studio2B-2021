      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Text style={styles.subHeading}>
            You must agree to the following policy before continuing.
          </Text>
          <Text style={styles.bodyText}>
            Last updated: May 12, 2021 Please read these terms and conditions
            ...
            these Terms and Conditions: Affiliate means an entity that controls,
            is controlled by or is under common control with a party, where
            "control" means ownership of 50% or more of the shares, equity
            interest or other securities entitled to vote for election of
            directors or other managing authority. Country refers to: New South
            Wales, Australia Company (referred to as either "the Company", "We",
            "Us" or "Our" in this Agreement) refers to AuthMe, 15 Broadway,
            Ultimo NSW 2007. Device means any device that can access the Service
            ...
            or made available by the Service. Website refers to Auth Me,
            accessible from http://www.authme.com.au You means the individual
            ...
            Service, as applicable. Acknowledgment These are the Terms and
            Conditions governing the use of this Service and the agreement that
            operates between You and the Company. These Terms and Conditions set
            ...
            the Service. You represent that you are over the age of 18. The
            Company does not permit those under 18 to use the Service. Your
            ...
            carefully before using Our Service. Links to Other Websites Our
            Service may contain links to third-party web sites or services that
            are not owned or controlled by the Company. The Company has no
            ...
            through the Service or 100 AUD if You haven't purchased anything
            ...
            please stop using the website and the Service. Contact Us If you
            have any questions about these Terms and Conditions, You can contact
            us: By email: office@authme.com
          </Text>
          <Button
            style={styles.button}
            title="Go Back"
