...
// Camera types
export const CAMERA_INSTANCE = 'CAMERA_INSTANCE';
export const CAPTURED_IMAGE = 'CAPTURED_IMAGE';
export const IMG_URI = 'IMG_URI';
export const CAMERA_READY = 'CAMERA_READY';
export const TAKE_PHOTO_CLICKED = 'TAKE_PHOTO_CLICKED';
